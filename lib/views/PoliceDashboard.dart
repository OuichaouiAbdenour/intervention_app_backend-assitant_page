            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<QuerySnapshot>(
                  stream: firestore.
                  collection('Police officer').where("valid",isEqualTo: true).snapshots(),
                            ...
                            subtitle: Column(
                              ...
                              children: [
                                ...
                                greenButton('delete police officer', (){
                                  firestore.collection('Police officer').doc(firefighter[index].id).delete();
                                }),
                                const SizedBox(
                                  height: 30,
                                ),
                                greenButton('cancel action', (){
                                  firestore.collection('Police officer').doc(firefighter[index].id).update({"occupee": "libre"});
                                }),
                              ],
                            ),
                            onTap: () {
