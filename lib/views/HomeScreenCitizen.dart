...
*/
  ...
  void buildSourceSheetFormFirefighter(bool showDescriptionFieldFirefighter,BuildContext context) {
    Get.bottomSheet(Container(
      width: Get.width,
      height:
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  var test = await locationController.selectIntervenant(authController.phoneNumber);
                  print(test);
                  ...
                  double markerSize = 48 * devicePixelRatio; // Adjust the size as needed
  ...
  void buildSourceSheetFormPoliceOfficer(bool showDescriptionField,BuildContext context) {
    Get.bottomSheet(Container(
      width: Get.width,
                ...
                Expanded(
                  child: DropdownButton<String>(
                    ...
                    onChanged: (String? newValue) {
                      ...
                      Get.back();
                      buildSourceSheetFormPoliceOfficer(showDescriptionField,context);
                    },
                    items: <String>['normal', 'Difficult', 'Very difficult']
                        .map<DropdownMenuItem<String>>((String value) {
                      return DropdownMenuItem<String>(
